...
export const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
  ({ className, variant = 'primary', size = 'md', isLoading, disabled, children, ...props }, ref) => {
    ...
    const variants = {
      ...
      secondary: 'bg-slate-800 hover:bg-slate-900 text-white shadow-md shadow-slate-900/20 focus:ring-slate-700',
      outline: 'border border-slate-300 hover:bg-slate-100/80 text-slate-700 focus:ring-blue-500 bg-white/70 backdrop-blur-sm',
